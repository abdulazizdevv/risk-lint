...
export function printClean(message: string) {
  writeLine()
  writeLine(`${pc.green(pc.bold("Clean"))} ${message}`)
}

export function printFindings(issues: Issue[]) {
